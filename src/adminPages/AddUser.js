                         ...
                         <div className="w-4/5 float-left">
                              ...
                              <section className="bg-purple-200 w-11/12 mt-10 rounded-l-lg py-3 float-right">
                                   ...
                                   <div className="flex justify-around mt-5">
                                        <div className="w-2/5 flex flex-col">
                                             <div className="font-bold w-fit mb-2">Password</div>
                                        ...
                                        <div className="w-2/5 flex flex-col">
                                             <div className="font-bold w-fit mb-2">Confirm Password</div>
                                   ...
                                   <div className="flex justify-around mt-5">
                                        <div className="w-2/5 flex flex-col">
                                             <div className="font-bold w-fit mb-2">Account Role</div>
